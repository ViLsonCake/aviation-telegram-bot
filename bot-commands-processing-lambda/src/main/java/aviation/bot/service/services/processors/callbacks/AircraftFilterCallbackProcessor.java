...
public class AircraftFilterCallbackProcessor implements CallbackProcessor {
  ...
  public CallbackType getCallbackType() {
    return CallbackType.AIRCRAFT_FILTER;
  }
  ...
  public void process(String username, long chatId, String callbackData, String callbackId) {
    ...
    aircraftFamilyFilterService.sendFilterKeyboard(chatId, optionalUser.get());
  }
}
